...
func (tx *Tx) init() {
	tx.AppQuery = NewAppQueryClient(tx.config)
	tx.AppResponse = NewAppResponseClient(tx.config)
...
// applies a query, for example: AppQuery.QueryXXX(), the query will be executed
