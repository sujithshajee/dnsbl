...
func (tc *TaskCreate) SetCompletedBy(t time.Time) *TaskCreate {
	tc.mutation.SetCompletedBy(t)
	return tc
}

// SetNillableCompletedBy sets the "completed_by" field if the given value is not nil.
func (tc *TaskCreate) SetNillableCompletedBy(t *time.Time) *TaskCreate {
	if t != nil {
		tc.SetCompletedBy(*t)
	}
	return tc
...
func (tc *TaskCreate) createSpec() (*Task, *sqlgraph.CreateSpec) {
	...
	if value, ok := tc.mutation.CompletedBy(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeTime,
			Value:  value,
